...
public class ExceptionController {
  ...
  /**
   * @param exception response thrown
   * @return string constant indicating DATABASE_UNAVAILABLE, date, and exception message
   */
  @ExceptionHandler(DatabaseNotAvailableException.class)
  protected ResponseEntity<ExceptionResponse> databaseNotAvailable(DatabaseNotAvailableException exception) {
    ExceptionResponse response =
